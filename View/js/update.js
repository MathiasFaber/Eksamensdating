...
updateBTN.addEventListener('click', function(e) {
    ...
    // If the requested fetch in the function user.updageUser went well, this callback function is called
    function myCallBack() { 
    ...
    // Calling the updateUser function in the User class with updateUser and myCallBack as inputs
